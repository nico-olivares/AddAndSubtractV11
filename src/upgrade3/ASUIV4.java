...
public class ASUIV4 extends JFrame implements ActionListener, ComponentListener {
...
class newPanel2 extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		gr.fillRect(0, 0, ASUIV4.centerPica.getWidth(), ASUIV4.centerPica.getHeight());
		if(ASUIV4.scoreNum == 0 && ASUIV4.level != 0) {
			explode(ASUIV4.pWidth, ASUIV4.pHeight);
		} else {
			drawPicachu(ASUIV4.pWidth, ASUIV4.pHeight);
		}
	}
	...
	private void drawPicachu(int w, int h) {
		...
		gr.fillOval((ASUIV4.xOffset+(w/4)), h/4, w/2, (int)((h/2)*0.9));
		gr.setColor(Color.blue);
		GeneralPath ear1 = new GeneralPath();
		ear1.moveTo((int)(ASUIV4.xOffset+((w/4)*1.2)), yPointOut);
		ear1.lineTo((int)(ASUIV4.xOffset+((w/4)*1.1)), yPointHigh);
		ear1.lineTo((int)(ASUIV4.xOffset+((w/4)*1.4)), yPointIn);
		ear1.closePath();
		GeneralPath ear2 = new GeneralPath();
		ear2.moveTo((int)(ASUIV4.xOffset+((w/4)*2.8)), yPointOut);
		ear2.lineTo(ASUIV4.xOffset+((w/4)*2.9), yPointHigh);
		ear2.lineTo(ASUIV4.xOffset+((w/4)*2.6), yPointIn);
		ear2.closePath();
		gr.fill(ear1);
		gr.fill(ear2);
		gr.setColor(Color.white);
		gr.fillOval((int)(ASUIV4.xOffset+((w/4)*1.3)), (int)((h/4)*1.3), (int)(w/8), (int)(h/7));
		gr.fillOval((int)(ASUIV4.xOffset+((w/4)*2.2)), (int)((h/4)*1.3), (int)(w/8), (int)(h/7));
		gr.setColor(Color.black);
		gr.fillOval((int)(ASUIV4.xOffset+((w/4)*1.55)), (int)((h/4)*1.5), (int)(w/20), (int)(h/18));
		gr.fillOval((int)(ASUIV4.xOffset+((w/4)*2.45)), (int)((h/4)*1.5), (int)(w/20), (int)(h/18));
		gr.setColor(Color.red);
		gr.fillOval((int)(ASUIV4.xOffset+(w*0.4)), (int)(h*0.57), (int)(w*0.22), (int)(h*0.04));
		gr.setColor(Color.blue);
		Arc2D.Float tongue = new Arc2D.Float((float)(ASUIV4.xOffset+(w*0.55)), (float) (h*0.56), (float)(w*0.033), (float)(h*0.062), 180f, 180f, Arc2D.CHORD);
		gr.fill(tongue);
	}
	
	private void explode(int w, int h) {
		gr.setColor(Color.white);
		gr.clearRect(0, 0, ASUIV4.centerPica.getWidth(), ASUIV4.centerPica.getHeight());
		gr.setColor(Color.yellow);
		GeneralPath cl = new GeneralPath();
		cl.moveTo(ASUIV4.xOffset+(w*0.2), (h*0.3));
		cl.curveTo(ASUIV4.xOffset+(w*0.2), (h*0.2), ASUIV4.xOffset+(w*0.4), (h*0.1), ASUIV4.xOffset+(w*0.4), (h*0.27));
		cl.curveTo(ASUIV4.xOffset+(w*0.45), (h*0.1) , ASUIV4.xOffset+(w*0.6), (h*0.1), ASUIV4.xOffset+(w*0.6), (h*0.3));
		cl.curveTo(ASUIV4.xOffset+(w*0.7), (h*0.12), ASUIV4.xOffset+(w*0.9), (h*0.4), ASUIV4.xOffset+(w*0.8), (h*0.5));
		cl.curveTo(ASUIV4.xOffset+(w*0.9), (h*0.5), ASUIV4.xOffset+(w*0.8), (h*0.8), ASUIV4.xOffset+(w*0.7), (h*0.7));
		cl.curveTo(ASUIV4.xOffset+(w*0.75), (h*0.9), ASUIV4.xOffset+(w*0.4), (h*1), ASUIV4.xOffset+(w*0.4), (h*0.7));
		cl.curveTo(ASUIV4.xOffset+(w*0.38), (h*0.9), ASUIV4.xOffset+(w*0.1), (h*0.6), ASUIV4.xOffset+(w*0.2), (h*0.55));
		cl.curveTo(ASUIV4.xOffset+(w*0.1), (h*0.5), ASUIV4.xOffset+(w*0.18), (h*0.25), ASUIV4.xOffset+(w*0.2), (h*0.3));
				
		cl.closePath();
		gr.fill(cl);
		
		gr.setColor(Color.black);
		gr.setFont(new Font("Comic Sans MS", Font.PLAIN, (int)(ASUIV4.pWidth*0.1)));
		gr.drawString("BOOM!", (int)(ASUIV4.xOffset+(w*0.3)), (int)(h*0.6));
